...
<section class="secao-video-full" style="<?php echo esc_attr($geraisCSS); ?>">
    <div class="container">
        <div class="secao-video-full__wrapper" style="background-image: url('<?php echo esc_url($imagem_capa); ?>');" data-video-url="<?php echo esc_url($video_url); ?>">
            <div class="secao-video-full__overlay"></div>
            
            <div class="secao-video-full__content">
                <div class="btn-video-full">
                    <img src="<?php echo esc_url($theme_url . '/public/images/player-video-full.svg'); ?>" alt="Play" class="btn-video-full__icon">
